...
class SearchStrategy:
    def search(self, query: str, metadata_filter: models.Filter) -> List[str]:
...
class HybridSearch(SearchStrategy):
    def query_hybrid_search(self, query: str, metadata_filter: models.Filter) -> List[str]:
...
def RetrieverAgent(state: dict) -> OpenAIAgent:
    ...
    def retriever(search_type: str, query: str, metadata_filter: models.Filter, reranking_model: str):
        """
